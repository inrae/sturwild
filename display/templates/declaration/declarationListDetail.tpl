<script>
    $(document).ready(function () {
        ...
        $("#declarationTypeForm").on("submit", function (event) {
    ...
    <div class="row">
        <div class="col-md-6 form-horizontal">
            ...
            <select id="checkedActionDeclaration" class="form-control">
                ...
                <option value="fishExportCSV">{t}Exporter les poissons rattachés aux déclarations en CSV{/t}</option>
                <option value="declarationExportJson">{t}Exporter les déclarations et les poissons rattachés (JSON){/t}
                </option>
            </select>
            <div class="formContent" hidden>
                <div class="form-group ">
                    <label for="use_exchange_labels" class="control-label col-md-4">
                        <span class="red">*</span> {t}Exporter les libellés des tables de paramètres dans le format
                        d'échange :{/t}
                    </label>
                    <div class="col-md-8">
                        <div class="radio">
                            <label>
                                <input type="radio" name="use_exchange_labels" id="use_exchange_labels1" value="1"
                                    checked>
                                {t}oui{/t}
                            </label>
                        </div>
