...
<a href="index.php?module={$tablename}List"><img src="display/images/list.png" height="25">{t}Retour à la liste{/t}</a>
<div class="row">
  <div class="col-md-6">
    <form class="form-horizontal protoform" id="paramForm" method="post" action="index.php">
      ...
      <div class="form-group">
        ...
        <div class="col-md-8">
          <input id="paramExchange" type="text" class="form-control" name="{$fieldexchange}"
            value="{$data.$fieldexchange}">
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="col-md-8">
          <input id="order" type="number" class="form-control" name="{$fieldorder}"
            value="{$data.$fieldorder}">
        </div>
      </div>
