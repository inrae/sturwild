...
<div class="row col-md-8">
    <form id="importForm" method="post" action="importCSVExec">
...
<div class="row">
    <div class="col-md-6">
        <form class="form-horizontal" id="controlForm" method="post" action="importCSVControl" enctype="multipart/form-data">
